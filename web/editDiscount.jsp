            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="editDiscount" method="post">
                        ...
                        <!-- Max Usage / Usage Count -->
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Số lần sử dụng tối đa</label>
                                <input type="number" name="maxUsage" class="form-control" 
                                       value="${discount.maxUsage}" min="1" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="usageCount" class="form-control" 
                                       value="${discount.usageCount}" min="0" required>
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-warning px-4">Lưu</button>
