                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="<%= uri.contains("chart") ? "nav-link active" : "nav-link" %>" href="chart">
                            ...
                            <a class="<%= uri.contains("room-type.jsp") ? "nav-link active" : "nav-link" %>" href="listRoomType">
                            ...
                            <a class="<%= uri.contains("approve-booking.jsp") ? "nav-link active" : "nav-link" %>" href="listapprovebooking">
                                ...
                                Duyệt đơn thuê phòng
                            </a>
                            <a class="<%= uri.equals("/hotelrentalmanagement/views/dashboard/service.jsp") ? "nav-link active" : "nav-link" %>" href="servicemanager">
                                <div class="sb-nav-link-icon"><i class="fas fa-concierge-bell"></i></div>
                                Quản lý dịch vụ
                            </a>
                            <a class="<%= uri.contains("commentmanager") ? "nav-link active" : "nav-link" %>" href="commentmanager">
