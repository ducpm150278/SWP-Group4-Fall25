...
<body>
                        ...
                        <% for (Combo combo : combos) { %>
                            <div class="food-card">
                                <div class="food-card-body">
                                    ...
                                    <div class="food-price">
                                        <% if (combo.getDiscountPrice() != null) { %>
                                            <span class="price-original">
                                                <%= String.format("%,.0f đ", combo.getTotalPrice()) %>
                                            </span>
                                            <span class="price-current">
                                                <%= String.format("%,.0f đ", combo.getDiscountPrice()) %>
                                            </span>
                                    ...
                                    <input type="hidden" name="comboQuantities" value="0"
                        ...
                        <% for (Food food : foods) { %>
                            <div class="food-card">
                                <div class="food-card-body">
                                    ...
                                    <input type="hidden" name="foodQuantities" value="0"
                                        id="food-<%= food.getFoodID() %>-hidden">
                                    <input type="hidden" name="foodPrice-<%= food.getFoodID() %>"
                                        value="<%= food.getPrice() %>">
                                </div>
                            </div>
                        <% } %>
            ...
            <div class="summary-section">
                ...
                <div class="summary-row">
                    ...
                    <span class="summary-value">
                        <%= String.format("%,.0f đ", bookingSession.getTicketSubtotal()) %>
                    </span>
                </div>
    ...
    <script>
        // ===== CONSTANTS =====
        const ticketTotal = Number('<%= bookingSession.getTicketSubtotal() %>');  // Tổng tiền vé
        ...
        // ===== COUNTDOWN TIMER =====
        let timeLeft = Number('<%= request.getAttribute("remainingSeconds") != null ? request.getAttribute("remainingSeconds") : 300 %>');
