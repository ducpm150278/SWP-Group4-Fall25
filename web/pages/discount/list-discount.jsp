            ...
            <div id="layoutSidenav_content">
                <main class="p-4">
                    <div class="container-fluid">
                        ...
                        <form action="${pageContext.request.contextPath}/listDiscount" method="get" class="mb-4">
                            ...
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-3 d-flex gap-2">
                                    ...
                                    <c:if test="${not empty param.keyword or not empty param.from or not empty param.to or not empty param.status}">
                                        <a href="${pageContext.request.contextPath}/listDiscount" class="btn btn-secondary w-100 shadow-sm rounded-3">
                        ...
                        <!-- Nút thêm mới -->
                        <a href="${pageContext.request.contextPath}/addDiscount" class="btn btn-success mb-3">➕ Thêm Chương Trình Khuyến Mại</a>
                            ...
                            <tbody>
                                <c:forEach var="item" items="${discounts}">
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/viewDiscount?discountID=${d.discountID}" class="btn btn-sm btn-info">Xem</a>
                                            <a href="${pageContext.request.contextPath}/editDiscount?discountID=${d.discountID}" class="btn btn-sm btn-warning">Sửa</a>
                                            <a href="${pageContext.request.contextPath}/deleteDiscount?discountID=${d.discountID}" 
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <ul class="pagination">
                                ...
                                <c:if test="${currentPage > 1}">
                                    <li class="page-item">
                                        <a class="page-link"
                                           href="${pageContext.request.contextPath}/listDiscount?page=${currentPage - 1}&keyword=${keyword}&start=${start}&status=${status}">
                                            « Trước
                                        </a>
                                    </li>
                                </c:if>
                                ...
                                <c:forEach begin="1" end="${totalPages}" var="i">
                                    <li class="page-item ${i == currentPage ? 'active' : ''}">
                                        <a class="page-link"
                                           href="${pageContext.request.contextPath}/listDiscount?page=${i}&keyword=${keyword}&start=${start}&status=${status}">
                                            ${i}
                                        </a>
                                    </li>
                                </c:forEach>
