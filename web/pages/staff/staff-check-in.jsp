            ...
            <div id="layoutSidenav_content">
                <main class="p-4">
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="${pageContext.request.contextPath}/staff-check-in" method="GET">
                        ...
                        <c:forEach var="booking" items="${bookings}">
                            ...
                            <jsp:useBean id="booking" scope="page" type="com.cinema.entity.BookingDetailDTO" />
                                        ...
                                        <div class="col-md-4 border-start">
                                            ...
                                            <c:choose>
                                                <c:when test="${booking.status == 'Confirmed' && booking.paymentStatus == 'Completed'}">
                                                    ...
                                                    <form action="${pageContext.request.contextPath}/staff-check-in" method="POST" class="d-grid">
