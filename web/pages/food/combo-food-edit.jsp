...
<%@ page import="com.cinema.entity.Food" %>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <a href="${pageContext.request.contextPath}/combo-management" class="back-btn">
                ← Back to Combos
            </a>
        </div>
                        ...
                        <div class="food-list">
                            ...
                            <div class="food-item">
                                ...
                                <div class="food-actions">
                                    <form action="${pageContext.request.contextPath}/combo-food-management" method="POST" style="display: inline;">
