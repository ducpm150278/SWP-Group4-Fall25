...
<%@page import="com.cinema.entity.BookingSession"%>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="summary-box">
            ...
            <div class="price-row" style="padding-top: 15px; border-top: 1px solid #2a2d35; margin-top: 10px;">
                <span><i class="fas fa-calculator"></i> Tạm tính:</span>
                <strong><%= String.format("%,.0f đ", bookingSession.getTotalAmount()) %></strong>
            </div>
            ...
            <div class="price-row total-row">
                ...
                <span><%= String.format("%,.0f đ", bookingSession.getTotalAmount() - bookingSession.getDiscountAmount()) %></span>
            </div>
        </div>
        ...
        <form method="post" action="${pageContext.request.contextPath}/booking/payment" id="paymentForm">
            ...
            <button type="submit" name="action" value="payment" class="btn-submit-payment" id="paymentButton">
                ...
                <span>Thanh Toán <%= String.format("%,.0f đ", bookingSession.getTotalAmount() - bookingSession.getDiscountAmount()) %></span>
