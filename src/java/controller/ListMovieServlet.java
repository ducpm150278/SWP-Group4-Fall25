...
public class ListMovieServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (keyword != null && !keyword.trim().isEmpty()) {
            // Nếu có keyword thì tìm theo title
            movies = dao.getMoviesByTitle(keyword.trim());
        } else {
            // Không có keyword -> lấy toàn bộ
            movies = dao.getAll();
        }

        // Gửi dữ liệu sang JSP
        request.setAttribute("movies", movies);
        request.setAttribute("keyword", keyword); // để hiển thị lại trong ô search
