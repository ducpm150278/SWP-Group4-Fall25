...
public class EditMovieServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
         try {
            ...
            // Chuyển releasedDate từ String -> LocalDate
            ...
            // Gọi DAO
            MovieDAO dao = new MovieDAO();
            dao.updateMovie(movieID, title, genre, summary, trailerURL, cast, director, duration, releasedDate, posterURL, status, languageId);

            response.sendRedirect("list");

        } catch (Exception e) {
            System.out.println("Lỗi khi update phim: " + e.getMessage());
