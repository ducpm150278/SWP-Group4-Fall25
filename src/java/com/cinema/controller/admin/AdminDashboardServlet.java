...
import com.cinema.dal.CinemaMDAO;
import com.cinema.dal.ScreeningRoomDAO;
import com.cinema.dal.SeatMDAO;
import com.cinema.dal.UserMDAO;
...
import com.cinema.utils.SeatLayout;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (section == null) {
                ...
                request.getRequestDispatcher(Constants.JSP_ADMIN_DASHBOARD).forward(request, response);
            } else {
                switch (section) {
