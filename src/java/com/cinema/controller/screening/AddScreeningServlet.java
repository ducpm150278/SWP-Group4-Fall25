...
public class AddScreeningServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher(Constants.JSP_SCREENING_ADD).forward(request, response);
    }
...
//            
            ...
            response.sendRedirect(request.getContextPath() + Constants.URL_LIST_SCREENING + "?addSuccess=1");
        } catch (Exception ex) {
            ex.printStackTrace();
